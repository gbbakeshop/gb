...
import ListTags from "@/_tags/list-tag";
import DetailsTag from "@/_tags/details-tag";
                        ...
                        {data?.map((res, index) => (
                            <li key={index}>
                                ...
                                >
                                    <ListTags
                                        branch_id={res.id}
                                        active="branch_raw_materials"
                                        href={route("branch_raw_materials", [
                                            res.id,
                                        ])}
                                    ...
                                    <ListTags
                                        branch_id={res.id}
                                        active="branch_bakers_production"
                                        href={route(
                                    ...
                                    <ListTags
                                        branch_id={res.id}
                                        active="branch_selecta"
                                        href={route("branch_selecta", [res.id])}
                                        icon={<IoFastFoodSharp />}
                                        title="selecta"
                                    />
                                    <ListTags
                                        branch_id={res.id}
                                        active="branch_accounts"
                                        href={route("branch_accounts", [
                                            res.id,
                                        ])}
                                        icon={<FaUsersCog />}
                                        title="accounts"
